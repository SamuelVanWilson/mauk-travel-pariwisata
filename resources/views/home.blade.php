        ...
        <section id="hero" class="h-screen flex justify-center items-center">
            <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div class="mr-auto place-self-center lg:col-span-7">
                    <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Temukan Destinasi Wisata Terbaik</h1>
                    <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Jelajahi tempat-tempat menakjubkan di daerah mauk dengan mudah. Rencanakan perjalanan Anda sekarang!</p>
        ...
        <section class="bg-white dark:bg-gray-900" id="feature">
            <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div class="m-auto mb-8 lg:mb-16 text-center">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Fitur Unggulan Kami</h2>
                    <p class="text-gray-500 sm:text-xl dark:text-gray-400 w-2/3 mx-auto">Solusi inovatif untuk perjalanan Anda dengan layanan terbaik.</p>
                </div>
                <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Destinasi Unggulan</h3>
                        <p class="text-gray-500 dark:text-gray-400">Pilih dari berbagai rekomendasi destinasi eksotis untuk liburan tak terlupakan.</p>
                    </div>
                    <div>
                        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-purple-100 lg:h-12 lg:w-12 dark:bg-purple-900">
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Kemudahan Transportasi</h3>
                        <p class="text-gray-500 dark:text-gray-400">Nikmati layanan pemesanan transportasi langsung dari platform kami.</p>
                    </div>
                    <div>
                        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-purple-100 lg:h-12 lg:w-12 dark:bg-purple-900">
                        ...
                        <p class="text-gray-500 dark:text-gray-400">Dapatkan penawaran harga terbaik yang sesuai dengan anggaran Anda.</p>
                    </div>
                </div>
            </div>
          </section>
        ...
        <section class="bg-white px-4 py-8 antialiased dark:bg-gray-900 md:py-16" id="product">
            <div class="mx-auto grid max-w-screen-xl rounded-lg bg-gray-50 p-4 dark:bg-gray-800 md:p-8 lg:grid-cols-12 lg:gap-8 lg:p-16 xl:gap-16">
              <div class="lg:col-span-5 lg:mt-0">
                <a href="#">
                  <img class="mb-4 h-56 w-56 dark:hidden sm:h-96 sm:w-96 md:h-full md:w-full rounded-md" src="{{ asset('asset_web/landing_page3.jpeg') }}" alt="peripherals" />
              ...
              <div class="me-auto place-self-center lg:col-span-7">
                ...
                <p class="mb-6 text-gray-500 dark:text-gray-400">Temukan berbagai pengalaman seru di seluruh daerah mauk dengan layanan kami. Rencanakan perjalanan Anda, hemat waktu, dan nikmati perjalanan tanpa khawatir.</p>
                <a href="{{ route('tours.index') }}" class="inline-flex items-center justify-center rounded-lg bg-purple-700 px-5 py-3 text-center text-base font-medium text-white hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 dark:focus:ring-purple-900">Pesan Sekarang</a>
              </div>    
            </div>
        </section>
