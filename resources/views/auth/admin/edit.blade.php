            ...
            <div class="mx-auto container max-w-2xl md:w-3/4 shadow-md">
              ...
              <form method="POST" enctype="multipart/form-data" action="{{ route('auth.update') }}" class="bg-white space-y-6">
                ...
                <div class=" p-4 text-right space-x-5 pb-4 mb-2">
                  <button type="submit" class="text-white mx-auto max-w-sm rounded-md text-center bg-purple-400 py-2 px-4 inline-flex items-center focus:outline-none md:float-right">
                    <svg
                      fill="none"
